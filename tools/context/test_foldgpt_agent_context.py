...
class ContextTest(unittest.TestCase):
    ...
    def test_selected_home_and_manifest_are_really_written_and_read_back(self):
        result = self.sync()
        self.assertEqual(result["selectedGuestFile"], "/home/julien/.codex/AGENTS.md")
    ...
    def test_explicit_codex_home_is_used_without_config_change(self):
        ...
        result = self.sync(codex_home="/home/julien/custom")
        self.assertEqual(result["selectedGuestFile"], "/home/julien/custom/AGENTS.md")
