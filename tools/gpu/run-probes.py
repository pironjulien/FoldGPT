...
def main():
    ...
    parser.add_argument("--api", choices=("vulkan", "glx", "timestamp", "partial", "both"), default="both")
    ...
    for api in apis:
        ...
        if api == "partial":
            environment = ["MESA_LOADER_DRIVER_OVERRIDE=zink", "GALLIUM_DRIVER=zink", "EGL_PLATFORM=surfaceless"]
            executable = "zink-partial-resolve-probe"
