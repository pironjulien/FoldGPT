...
SUITES = (
    ...
    "tools/executor/test_native_client.py",
    "tools/executor/test_private_session_owner.py",
    ...
    "tools/install/rootfs_sources_test.py",
    "tools/runtime/test_android_memory.py",
    "tools/runtime/test_device_baseline.py",
    "tools/runtime/test_candidate_build.py",
    "tools/runtime/test_install_workspace_provider.py",
