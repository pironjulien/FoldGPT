...
```powershell
wsl -d Ubuntu-24.04 -u nobody --exec /bin/bash /mnt/c/Dev/ChatgptFold/tools/executor/gnu-runtime/run-linux-tests.sh /var/tmp/foldgpt-proot-strict-Eu22Ab0a/patched/src/proot
```
