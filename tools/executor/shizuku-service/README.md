...
wsl.exe -e /usr/sbin/runuser -u nobody -- python3 /mnt/c/Dev/FoldGPT/tools/executor/shizuku-service/verify-native-host.py
wsl.exe -e /usr/sbin/runuser -u nobody -- python3 /mnt/c/Dev/FoldGPT/tools/executor/shizuku-service/verify-bootstrap-host.py
```
