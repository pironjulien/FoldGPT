...
def verify(report):
    ...
    require(report['schema'] == 'foldgpt.runas.broker-activity.v1', 'Wrong Activity schema')
    require(report['action'] == 'app.foldgpt.runasbrokerqualification.v1.RUN_BROKER_V1', 'Wrong independent action')
    require(report['state'] == 'complete' and report['passed'] is True, 'Activity failed')
    service = report['service']
    require(service['schema'] == 'foldgpt.runas.broker-service.v1', 'Wrong service schema')
    ...
    require(installed['qualification']['packageName'] == 'app.foldgpt.runasbrokerqualification.v1', 'Wrong diagnostic APK')
    ...
    require(installed['nativeLibraries']['libfoldgpt_qualification_worker.so']
            == '1f7054085ecfd920626cdf24603687cd5e9812b445cf171a2f4cff8efbecd3aa', 'Wrong fixed Bionic workload')
    ...
    require(child['schema'] == 'foldgpt.runas.broker-child.v1' and receipt['schema'] == 'foldgpt.runas.broker-report.v1', 'Wrong native receipt schemas')
    ...
    require(child['options']['workspace'] == '/data/user/0/app.foldgpt/files/runas-native-v1/workspace', 'Workspace is not app-private')
    return {'schema': 'foldgpt.runas-broker-verification.v1', 'passed': True, 'kernelProofs': len(PROOFS),
