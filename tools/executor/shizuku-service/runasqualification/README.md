...
gradle :runasqualification:assembleDebug -PfoldgptFrozenTransportJni=C:/Dev/FoldGPT/tools/executor/shizuku-lab/build/frozen-transport-jni --no-daemon --console=plain
```
