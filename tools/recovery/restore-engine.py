"""Recover the pinned upstream engine and the published integration patch."""
import argparse
import hashlib
import json
...
def main():
    ...
    # Keep the upstream remote fetch-only. Contributors can add their own fork
    # as a separate push remote after reviewing their changes.
