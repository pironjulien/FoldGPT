...
- The active official client reports llvmpipe and software GPU composition. EGL initialization in the Android display layer does not establish client GPU acceleration; a low idle CPU value does not measure active rendering performance.
