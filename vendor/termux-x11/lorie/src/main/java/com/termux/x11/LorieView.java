...
public class LorieView extends SurfaceView implements InputStub {
    ...
    /** Main thread only: 1 = complete frame sent, 0 = retryable without bytes sent, -1 = failure. */
    public int sendInputEventChecked(int code, boolean unicode, boolean down) {
        return sendInputEventChecked(mNativeContext, code, unicode, down);
    }
    @FastNative private native int sendInputEventChecked(long ptr, int code, boolean unicode, boolean down);
