...
// The connection dispatcher and redraw/cursor signals all run on the server
// thread. Apply the descriptor in socket order before subsequent server actions.
