...
See the [historical native-startup audit](../../docs/history/native-startup-2026-09-05.md), [security policy](https://github.com/pironjulien/FoldGPT/blob/main/SECURITY.md) and [maintained tests](../../tests/README.md).
