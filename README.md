...
- The official client reports ANGLE on Zink/Turnip and Adreno 840, with GPU composition and rasterization enabled. The installed Mesa revision 4 and corrected Xlorie pass the GPU pixel tests and a visible File-menu check; broader display reliability and application FPS remain unmeasured. See [the device checkpoint](docs/verification-2026-09-06.md).
